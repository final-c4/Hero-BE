...
public interface PaymentHistoryMapper {
     ...
     * @return 전체 조회 건수
     */
    int countPayrollSearch(@Param("req") PayrollPaymentSearchRequest req);
     ...
     */
    List<PayrollPaymentSearchRowResponse> selectPayrollSearch(
            @Param("req") PayrollPaymentSearchRequest req,
     ...
     * @return 급여 상세 요약 정보
     */
    PayrollPaymentDetailSummaryResponse selectPayrollDetail(@Param("payrollId") Integer payrollId);
     ...
     */
    List<PayrollPaymentDetailResponse.PayrollItemRow> selectPayrollItems(@Param("payrollId") Integer payrollId);
}
